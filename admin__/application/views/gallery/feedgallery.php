<div class="col-lg-6" id="newCat">
    <div class="panel panel-default" style="height:305px;overflow: auto">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-12">
                    <?php echo form_open_multipart('admin_/feedCategory', array('name' => 'frmNewsEvents', 'id' => 'frmNewsEvents', 'role' => 'form')); ?>
...
<div class="col-lg-6" id="editCat" style="display:none">
    <div class="panel panel-default" style="height:305px;overflow: auto">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-12">
                    <?php echo form_open_multipart('admin_/editCategory', array('name' => 'frmNewsEvents', 'id' => 'frmNewsEvents', 'role' => 'form')); ?>
                    <div class="form-group">
                        <label>Category</label>
                        <?php
                        $data = array(
