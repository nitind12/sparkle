                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    ...
                                    <div style="float: right">
                                        <?php //echo anchor('admin_/delete_news/' . $item->ID, '<span style="font-size: 11px; color: #ff0000; font-weight: bold; background: #ffff00; padding: 2px">x</span>', array('style' => 'float: right')); ?>
                                    </div>
                                    <div style="float: right; padding: 3px; background: transparent">|</div>
                                    <div style="float: right">
                                        <?php echo anchor('admin_/active_deactive_news/' . $item->ID . '/1', '<span style="font-size: 11px; color: #009000; background: #ffff00; padding: 2px">Activate</span>', array('style' => 'float: right')); ?>
                                    </div>
                                </h4>
